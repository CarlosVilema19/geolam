...
public class ActualizarLugarMedicoAdaptador extends ArrayAdapter<ListadoAsignarLugarMedico> {
    private ArrayList<ListadoAsignarLugarMedico> arrayList= new ArrayList<>();
    private Context context;
    public ActualizarLugarMedicoAdaptador(@NonNull Context context){
